...
[task_local]
0 0 * * * http://nm6.xyz:20080/ningmeng/ningmeng/raw/branch/main/jieka.js, tag=节卡机器人, enabled=true
*/
    ...
    if (typeof $request !== "undefined") {
        ...
        if (!(await Envs()))
            ...
            for (let index = 0; index < jiekahdArr.length; index++) {
               ...
               await ota('other/fault','{}')
               await ota('userScore/get','{}')  
               await ota('forum/add','{"postType":"","title":"我爱节卡机器人","content":"我爱节卡机器人","attachments":";;"}')
               await ota('userScore/get','{}') 
               ...
               log('积分：'+res.data.score) 
               msg += '积分：'+res.data.score                                             
            }
            await SendMsg(msg);
        }
    }
